  ...
  module Api
    class WebhookController < ::ApplicationController
      ...
      def handle_connection_update(payload)
        ...
        WhatsappLiteEvent.track!(account_id: channel.account_id, instance_id: channel.instance_id, event_type: "connection_changed", status: new_status.to_s, metadata: { state: payload.dig(:data, :state) }) rescue nil if new_status
      end
      ...
      def handle_message_upsert(payload)
        ...
        WhatsappLiteEvent.track!(account_id: channel.account_id, instance_id: channel.instance_id, event_type: "message_received", source_id: evolution_id, status: "success", metadata: { message_id: message.id, from_me: from_me, media: media_type }) rescue nil
