module WhatsappLite
  class SendMessageJob < ApplicationJob
    ...
    def perform(message_id)
      ...
      WhatsappLiteEvent.track!(account_id: message.account_id, instance_id: channel.instance_id, event_type: "message_sent", source_id: message.source_id, status: "success", metadata: { message_id: message_id, phone: number }) rescue nil
      end
      ...
      raise
      WhatsappLiteEvent.track!(account_id: message&.account_id, instance_id: channel&.instance_id || "unknown", event_type: "message_sent", source_id: message&.source_id, status: "failed", metadata: { message_id: message_id, error: e.message }) rescue nil
    end
  end
end
